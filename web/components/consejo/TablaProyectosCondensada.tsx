...
export default function TablaProyectosCondensada({
  proyectos,
}: TablaProyectosCondensadaProps) {
          ...
          <tbody className="divide-y divide-slate-200">
            {proyectos.map((proyecto) => {
              ...
              return (
                ...
                >
                  <td
                    className="max-w-[220px] truncate px-5 py-3 font-medium"
                  ...
                  <td className="px-5 py-3">
                    {formatearFecha(proyecto.fechaFinPrevista)}
                  </td>
                </tr>
              );
            })}
